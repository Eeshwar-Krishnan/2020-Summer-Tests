...
public class ConstantVOdometer extends Odometer {
    ...
    private static final double AUX_ROTATION_CONSTANT = 3600;
    private static final double TRANSLATION_FACTOR = (0.0011);
    ...
    public ConstantVOdometer(StateMachine stateMachine, Vector3 position, Vector3 velocity, double x, double y) {
        ...
        this.x = x / TRANSLATION_FACTOR;
        this.y = y / TRANSLATION_FACTOR;
